...
chaining `.middleware(mw)` on the returned route (the v1
...
Server bootstrap and TLS knobs also changed substantially — see
[Transports overview](./transports.md) and the migration guide.
