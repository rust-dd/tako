...
pub(crate) type BoxedBody = UnsyncBoxBody<Bytes, BoxedError>;
...
pub(crate) type BoxedResponseFuture<R = Response> =
...
pub(crate) type BoxedRequestFuture =
...
pub(crate) type BoxedMiddleware = Box<
